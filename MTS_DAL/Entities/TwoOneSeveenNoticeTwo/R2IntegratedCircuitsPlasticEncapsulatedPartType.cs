...
{
    public class R2IntegratedCircuitsPlasticEncapsulatedPartType
    {
        [Key]
        ...
        [ForeignKey("PlasticEncapsulatedPackageType")]
        public int PackageTypeId { get; set; }
        public R2IntegratedCircuitsPlasticEncapsulatedPackageType PlasticEncapsulatedPackageType { get; set; } = null!;
    }
}
